...
pub trait Substituter: Sized {
    ...
    async fn from_url(url: &str) -> anyhow::Result<Option<Self>>;
    ...
    async fn fetch_debuginfo_from(
        ...
        let dir_to_add = match &magic(file.as_path()).await? {
            ...
            m if m.starts_with(b"{") => {
                ...
                return self
                    .fetch_debuginfo_from(redirect_path.as_path(), max_redirects - 1)
                    .await;
            }
            m => {
